 ...
 */
final class Version20210617102605 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE legal_form (id INT AUTO_INCREMENT NOT NULL, society_id INT NOT NULL, relation_id INT NOT NULL, name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_7FF313F8E6389D24 (society_id), UNIQUE INDEX UNIQ_7FF313F83256915B (relation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE society (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(150) NOT NULL, siren_number INT NOT NULL, city_of_registration VARCHAR(150) NOT NULL, registration DATE NOT NULL, capital DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
